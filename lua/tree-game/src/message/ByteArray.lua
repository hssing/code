...
function ByteArray:getBytes(__offset, __length)
  return self:getPack(__offset, __length)
...
function ByteArray:readInt64()
  ...
  __va.high = self:readUInt()
  __va.low = self:readInt()
  __va.key = __va.high.."_"..__va.low
  return __va;
  -- local __va = Int64.new()
  -- __va:setHigh(self:readUInt())
  -- __va:setLow(self:readInt())
--  local __, __v = string.unpack(self:readBuf(4), self:_getLC("i"))
--  __va:setLow(__v)
--  local __vv, __vvv = string.unpack(self:readBuf(4), self:_getLC("I"))
--  __va:setHigh(__vvv)
  -- return __va
end

function ByteArray:writeInt64(__int64)
  self:writeUInt(__int64.high)
  self:writeInt(__int64.low)
  return self
end
